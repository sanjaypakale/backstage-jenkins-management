...
import { Table, TableColumn, Progress, ResponseErrorPanel, TableFilter } from '@backstage/core-components';
...
export const DenseTable = ({ users }: DenseTableProps) => {
    ...
    return (
        <Table
            ...
            options={{ search: true, paging: false, searchFieldAlignment: 'right' }}
            columns={columns}
            data={data}
